...
public class MainSearchCHN extends Search implements ModelDriven {
	...
	public String refineQuery(String st) {
		...
		st = st.replaceAll("sat=", "sat_1_min<=");
		st = st.replaceAll("intlFinacialAid", "Intl_Finacial_Aid");
		...
		st = st.replaceAll("size='小型：少于 2000学生';", "Size<2000");
