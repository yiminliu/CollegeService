...
<s:form name="search" method="POST" action="/search/Search.action"
	...
	<table align="center" id="search" border="2" cellspacing="2"
		...
		<tr>
			<s:textfield label="TOEFL Score" name="toefl" size="13"
				maxlength="10" />
		</tr>
		<tr>
			<s:textfield label="SAT1 Score" name="sat1" size="13" maxlength="10" />
		</tr>
		<tr>
		...
		<tr>
			<s:select label="Category" name="category" size="1" headerKey="1"
				headerValue="-- Please Select --"
				list="{'Research University','Liberal Arts College','No Preference'}" />
		</tr>
		<tr>
